...
#define DUK_HSTRING_FLAG_ES6SYMBOL                  DUK_HEAPHDR_USER_FLAG(3)  /* string is es6 symbol (implies internal) */
...
#define DUK_HSTRING_HAS_ES6SYMBOL(x)                DUK_HEAPHDR_CHECK_FLAG_BITS(&(x)->hdr, DUK_HSTRING_FLAG_ES6SYMBOL)
...
#define DUK_HSTRING_SET_ES6SYMBOL(x)                DUK_HEAPHDR_SET_FLAG_BITS(&(x)->hdr, DUK_HSTRING_FLAG_ES6SYMBOL)
...
#define DUK_HSTRING_CLEAR_ES6SYMBOL(x)              DUK_HEAPHDR_CLEAR_FLAG_BITS(&(x)->hdr, DUK_HSTRING_FLAG_ES6SYMBOL)
